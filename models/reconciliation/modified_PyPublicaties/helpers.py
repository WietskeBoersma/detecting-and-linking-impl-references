...
def ontsluit_handelingen(query_part2, startRecord=1, maximumRecords=1000):
    ...
    params = {
        ...
        "version": "2.0",
        "query": "c.product-area==officielepublicaties AND  w.publicatienaam='Kamerstuk' AND dt.creator = Tweede Kamer der Staten-Generaal",
...
def retrieve_publications(query_list=[], max_records=1000, start_record=1):
    query_concatter = " AND "
    query_part2 = " AND  w.publicatienaam='Handelingen'"
