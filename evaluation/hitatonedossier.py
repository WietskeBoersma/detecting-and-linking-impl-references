...
def get_hit_and_predicted_doc(search_term):
    ...
    for gold in true_data:
        ...
        if gold_dossier == pred_dossier and score > best_score:
            best_score = score
            best_match = gold
...
if "hit-at-1-dossier" not in df_pred.columns:
    df_pred["hit-at-1-dossier"] = pd.NA
...
for idx, row in df_pred.iterrows():
    ...
    df_pred.at[idx, "hit-at-1-dossier"] = hit
...
# eerst voor elk json file apart, vervolgens allen samenvoegen mbv combining.py
